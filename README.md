...
Link to the worker I used is [here](https://nokira-api.live-by-unix.workers.dev/): https://nokira-api.live-by-unix.workers.dev/ (The newest version of the website does not utlize workers anymore)
